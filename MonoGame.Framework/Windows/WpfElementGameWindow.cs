...
{
    public class WpfElementGameWindow : GameWindow
    {
        private UserControl _form;

        public UserControl Form { get { return _form; } }
        ...
        public override Microsoft.Xna.Framework.Point Position { get; set; }
        ...
        internal WpfElementGameWindow(WpfGamePlatform platform)
        {
            _platform = platform;
            Game = platform.Game;
